...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918184705_users21")]
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 47, 5, 107, DateTimeKind.Local).AddTicks(9110),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "dcc28cba-f60f-4bef-9d99-b0aba13dc958",
                            HashPassword = "UhSKJRBDE+MR7b6ZJBAdQw==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
