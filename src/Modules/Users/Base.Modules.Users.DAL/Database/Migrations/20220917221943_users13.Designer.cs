...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220917221943_users13")]
    partial class users13
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 1, 19, 43, 10, DateTimeKind.Local).AddTicks(1617),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "6ff8366e-1720-4ae1-b5ad-802f19284f5a",
                            HashPassword = "8r9Cc81A9nrJVbPok9NeJw==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
