...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918180636_users15")]
    partial class users15
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 6, 36, 207, DateTimeKind.Local).AddTicks(402),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "b7abfaad-a0f7-4839-81e2-129d135ab066",
                            HashPassword = "v9ZkbL6OWjnGUBncpCcb+w==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
