...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220919110704_users26")]
    partial class users26
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 19, 14, 7, 4, 353, DateTimeKind.Local).AddTicks(5066),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "ba4292a7-021f-43a9-9fb2-44314614e087",
                            HashPassword = "+SlKqRU7VtXoAQ+WcbSqcQ==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
