...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918182900_users17")]
    partial class users17
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 29, 0, 287, DateTimeKind.Local).AddTicks(698),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "2e29ecb8-2def-4d66-a507-838ad8f09cb7",
                            HashPassword = "eFCph7N+0RrTM8+c6fGNPg==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
