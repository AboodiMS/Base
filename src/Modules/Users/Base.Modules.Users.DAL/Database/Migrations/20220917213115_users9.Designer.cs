...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220917213115_users9")]
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 0, 31, 15, 384, DateTimeKind.Local).AddTicks(3955),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "7b8fb66c-61c0-4d1e-8440-ab64be4c0b38",
                            HashPassword = "hWsYyefQ4m2oVkXrl4AxbA==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
