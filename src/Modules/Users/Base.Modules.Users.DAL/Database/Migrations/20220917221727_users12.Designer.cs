...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220917221727_users12")]
    partial class users12
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 1, 17, 26, 788, DateTimeKind.Local).AddTicks(5203),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "75fdf9ca-0777-4b24-b8b2-88c13186f9a0",
                            HashPassword = "isgRHZOXsjiGjhvh5EchDg==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
