...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918190759_users24")]
    partial class users24
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 22, 7, 59, 518, DateTimeKind.Local).AddTicks(62),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "462917c3-d815-480b-ba2a-5c6a7cdd9fd6",
                            HashPassword = "sFGijqF61TZIMIEKKoIMEg==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
