...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918182620_users16")]
    partial class users16
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 26, 19, 608, DateTimeKind.Local).AddTicks(4522),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "366feb46-45b9-4427-ad34-ae9c4cb49e8c",
                            HashPassword = "dk5wPILHoFfhVWWUQMVVTQ==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
