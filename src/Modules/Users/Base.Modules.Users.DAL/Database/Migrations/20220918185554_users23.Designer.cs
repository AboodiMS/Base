...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918185554_users23")]
    partial class users23
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 55, 54, 213, DateTimeKind.Local).AddTicks(3168),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "362b8d32-89a1-40e0-8598-43996581231f",
                            HashPassword = "N1ci4d+2oz4lwpxUpNlZsw==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
