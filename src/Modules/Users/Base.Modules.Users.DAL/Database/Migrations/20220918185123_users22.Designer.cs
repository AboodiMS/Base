...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918185123_users22")]
    partial class users22
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 21, 51, 23, 252, DateTimeKind.Local).AddTicks(2556),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "bef052a2-42fb-477d-8f3a-716c6c4c58d9",
                            HashPassword = "XQIfuY2cOOt2JBUAqOWDgw==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
