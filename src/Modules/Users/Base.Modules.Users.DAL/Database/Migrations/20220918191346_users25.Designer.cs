...
namespace Base.Modules.Users.DAL.Database.Migrations
{
    ...
    [Migration("20220918191346_users25")]
    partial class users25
    {
            ...
            modelBuilder.Entity("Base.Modules.Users.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 9, 18, 22, 13, 45, 626, DateTimeKind.Local).AddTicks(9447),
                            CreatedUserId = new Guid("11111111-1111-1111-1111-111111111111"),
                            HashCode = "5198ed0d-f24b-4d8b-adff-3362c682a495",
                            HashPassword = "Hfgww+kFY7eWmKPoGTcozg==",
                            IsActive = true,
                            IsAdmin = true,
                            IsDeleted = false,
                            LoginName = "1",
